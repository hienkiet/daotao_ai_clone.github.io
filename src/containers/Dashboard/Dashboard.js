...
function Dashboard({ darkTheme }) {
  ...
  return (
    <Fragment>
      ...
      <Chart data={userData} title="Course Analytics Per Month" grid dataKey="Course Enrolled"/>
      </Box>
      <Box my={5} style={{ minHeight: 520 }}>
            <Apexchart />
      </Box>
      <Box my={5} style={{ minHeight: 520 }}>
        <Box mx={6} py={3}>
          <Typography variant="h5" gutterBottom>
            <strong>More and more usefull Course from World !</strong>
          </Typography>
          <Typography variant="subtitle1" gutterBottom>
            You can choose any courses that you want ... 
          </Typography>
        </Box>
        <CourseList />
      </Box>
      ...
      <Box className={classes.intro}>
        ...
        >
          <Box mx={5} minWidth={315} alignSelf="center">
            ...
            <Box mt={3}>
              <Typography>
                Simply sign up as a verified user on Daotao.ai to start to
        ...
        >
            ...
            <Box display="flex">
              ...
              <Box ml={1} display="flex" flexDirection="column">
                ...
                <Typography style={{ marginTop: 16 }}>
                  Daotao.ai is collect on many resourses. People who study at
                  the Daotao.ai can archive knowledge by join suitable topic.
                </Typography>
              </Box>
            </Box>
          </Box>
          ...
          <Box alignSelf="flex-start" maxWidth={500} m={5}>
            <Box display="flex">
              ...
              <Box ml={1} display="flex" flexDirection="column">
                <Typography variant="h4">
                  With Daotao.ai, students can easy to achieve the desired skills
                </Typography>
                <Typography style={{ marginTop: 16 }}>
                  Daotao.ai system is meticulously built to enhance the
